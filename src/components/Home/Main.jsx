  ...
  return (
    <div className={style.Container}>
        ...
        <div className={style.SectionAppSmall}>
            <span className={style.TitleDiv}>
                    Biznes ochish
                <h2>Biznesni ro‘yxatdan o‘tkazish</h2>
            </span>
